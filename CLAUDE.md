...
- **The mark is a BLOCK with the letter on it**, not a bare letter.
  ...
  the block, in pink, on the app's warm black, with the rim along its top edge
  and the frosted band across its bottom 26%. A flat letter has neither and
  reads as a sticker. Rendered and compared at 1024 and at 60pt: pink-on-pink
  is prettier large and turns to mush small; the pink letter on black holds at
  both.
